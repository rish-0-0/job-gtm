...
ENRICHMENT_BATCH_SIZE = 10  # Number of jobs to process per batch
ENRICHMENT_BATCH_TIMEOUT = 5.0  # Seconds to wait for batch collection
PUPPETEER_RATE_LIMIT = 2  # Max concurrent Puppeteer scraping sessions
OLLAMA_RATE_LIMIT = 5  # Max concurrent Ollama API calls
